...
Version  : 0.1.4
Release  : 4
URL      : https://github.com/cboxdoerfer/fsearch/archive/0.1.4/fsearch-0.1.4.tar.gz
Source0  : https://github.com/cboxdoerfer/fsearch/archive/0.1.4/fsearch-0.1.4.tar.gz
...
%prep
%setup -q -n fsearch-0.1.4
cd %{_builddir}/fsearch-0.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657061403
...
cp %{_builddir}/fsearch-0.1.4/License %{buildroot}/usr/share/package-licenses/fsearch/179ed4834368188595c686f81ba1ba6ab8dd0a19
